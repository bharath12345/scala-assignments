...
abstract class TweetSet {
  ...
  def findMax(curr: Tweet): Tweet = {
    if(this.isEmpty) curr
    else if(this.head.retweets > curr.retweets) this.tail.findMax(this.head)
    else this.tail.findMax(curr)
  }
  
  def findMax: Tweet = {
    this.tail.findMax(this.head)
  }
}
